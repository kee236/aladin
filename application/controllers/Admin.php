...
class Admin extends Home
{
    ...
    public function analytics_settings_action()
    {
        ...
        file_put_contents(APPPATH.'views/'.getTheme().'include/fb_px.php', $pixel_code, LOCK_EX);
        file_put_contents(APPPATH.'views/'.getTheme().'include/google_code.php', $google_code, LOCK_EX);
