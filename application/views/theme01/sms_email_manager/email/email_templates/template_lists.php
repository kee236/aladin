<?php include("application/views/theme01/sms_email_manager/email/email_templates/sms_email_manager_css.php"); ?>
<?php include("application/views/theme01/sms_email_manager/email/email_templates/sms_email_manager_js.php"); ?>
