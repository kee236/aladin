...
<html lang="en">
	<head>
	  ...
	  <?php
	  include(FCPATH.'application/views/theme01/include/css_include_back.php');
	  include(FCPATH.'application/views/theme01/include/js_include_back.php');
	  ?>
	</head>
	...
	<body class="<?php echo $body_class;?>">
	  <div id="app">
	    <div class="main-wrapper" style="background-color:#dde5ec;">
			<?php
			include(FCPATH.'application/views/theme01/admin/theme/header.php');

			include(FCPATH.'application/views/theme01/admin/theme/sidebar.php');
			echo '<div class="main-content '.$main_content_class.'">';
				$this->load->view($body);
			echo '</div>';
			include(FCPATH.'application/views/theme01/admin/theme/footer.php'); ?>
		</div>
	  </div>
	</body>
</html>
