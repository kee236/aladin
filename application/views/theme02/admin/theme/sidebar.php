<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        <img src="<?php echo base_url(); ?>/assets/theme02/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Ingetrations</h6>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php echo $this->uri->segment(1) == 'social_accounts' ? 'active' : '' ?>" href="<?php echo base_url();?>social_accounts">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Facebook & Instagram</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  <?php echo $this->uri->segment(1) == 'integration' ? 'active' : '' ?>" href="<?php echo base_url();?>integration">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">API channels</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Comment Feature</h6>
        </li>
        <li class="nav-item">
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="full-background" style="background-image: url('<?php echo base_url(); ?>/assets/theme02/img/curved-images/white-curved.jpeg')"></div>
